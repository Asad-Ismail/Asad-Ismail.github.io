...
assert len(pages[root/'index.html'].schemas) == 1
print(f'PASS: {len(pages)} HTML pages, all internal links/assets, heading structure, JSON-LD, {expected_posts} articles, {len(projects)} projects')
