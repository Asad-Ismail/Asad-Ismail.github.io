...
- `layouts/partials/ai-orbit.html`: the user's requested small orbit illustration, drawn as an accessible inline SVG. It sits under the portrait on desktop and after the introduction on mobile, uses the dark theme colors, and has no animation.
